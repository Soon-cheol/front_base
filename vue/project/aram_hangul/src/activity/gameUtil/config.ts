export default {
  reload: 'https://dev.arambookclub.com/hangul',
  restAPI: 'https://imestudy.smartdoodle.net:443/rsc/',
  restAPIProd: 'https://qa-api.arambookclub.com/learning/hangul/activities',
  w: 1280,
  h: 720,
  fontAry: ['BareunBatangOTFM', 'TmoneyRoundWindExtraBold', 'NanumBarunGothic'],
  studyDay: 1,
