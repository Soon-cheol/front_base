    ...
    <div class="prod-info">
      ...
      <div class="info">
        <ul class="ico">
          <li
            v-if="
              prodInfo.seriesCdList[0] === 'SZ01' ||
                prodInfo.seriesCdList[1] === 'SZ01'
            "
            class="babyall"
          >
            베이비올
          ...
          <li
            v-if="
              prodInfo.seriesCdList[0] === 'SZ02' ||
                prodInfo.seriesCdList[1] === 'SZ02'
            "
            class="kidsall"
          >
            키즈올
          ...
          <li
            v-if="
              prodInfo.seriesCdList[0] === 'SZ03' ||
                prodInfo.seriesCdList[1] === 'SZ03'
            "
            class="school"
          >
            스쿨
          ...
          <li
            v-if="
              prodInfo.seriesCdList[0] === 'SZ99' ||
                prodInfo.seriesCdList[1] === 'SZ99'
            "
            class="etc"
          >
            기타
        ...
        <ul class="detail">
          ...
          <li>
            <span class="tit-info">한줄 소개</span>
            <p class="txt-info">{{ prodInfo.prodDstnCtt }}</p>
          </li>
          <li>
            <span class="tit-info">상품 가격</span>
            <p class="txt-info">{{ prodInfo.prodAplyPric }}원</p>
          </li>
          <li>
            <span class="tit-info">상품 구성</span>
            <p class="txt-info">{{ prodInfo.prodCmpstn }}</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    async getProdDetail() {
      try {
        const { data } = await this.$axios.get(
          `/prod/regular/${this.$route.params.id}`,
          {
            params: {
        ...
        if (data.result) {
          this.prodInfo = data.result.prodDetail
